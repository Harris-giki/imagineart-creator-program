...
const COLUMNS: { heading: string; links: { label: string; href: string }[] }[] = [
  ...
  },
  {
    heading: 'Pricing',
    links: [
      { label: 'See Plans', href: `${BASE}/subscription` },
    ],
  },
]
  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        {/* Top section */}
        <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '40px 40px 0' }}>
          <div className="ia-footer-top">

            {/* Brand column */}
            <div className="ia-footer-brand">
              <img
              ...
              />
              <span style={{ display: 'block', fontSize: '11px', fontWeight: 600, letterSpacing: '0.5px', color: 'rgba(255,255,255,0.38)', marginBottom: '10px' }}>
                Try Imagine Mobile
              </span>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                ...
                >
                  <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: '14px', height: '14px', flexShrink: 0 }}>
                    <path d="M3.18 23.75c.33.18.7.26 1.08.22l13.12-7.57-2.82-2.82-11.38 10.17zM.75 1.13C.28 1.63 0 2.39 0 3.36v17.28c0 .97.28 1.73.76 2.22l.12.11 9.68-9.68v-.23L.87 3.02.75 1.13zM20.9 9.61l-2.8-1.62-3.15 3.14 3.15 3.15 2.81-1.62c.8-.46.8-1.21 0-1.67v.62zM4.26.25L17.38 7.82l-2.82 2.82L3.18.47A1.39 1.39 0 014.26.25z" />
                  </svg>
                  Google Play
                </a>
              </div>
            ...
            {/* Link columns grid */}
            <div className="ia-footer-columns">
              {COLUMNS.map((col) => (
                <div key={col.heading}>
                  <span style={{ display: 'block', fontSize: '11px', fontWeight: 600, letterSpacing: '0.5px', color: 'rgba(255,255,255,0.38)', marginBottom: '20px' }}>
                    {col.heading}
                  </span>
                    ...
                    {col.links.map((l) => (
                      <li key={l.label}>
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          style={{ fontSize: '13px', lineHeight: 1.4, color: 'rgba(255,255,255,0.55)', textDecoration: 'none' }}
                        >
                          {l.label}
                        </a>
                      </li>
        ...
        {/* Watermark */}
        <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '16px 40px 0', textAlign: 'center', lineHeight: 0, userSelect: 'none', pointerEvents: 'none' }}>
          <img
            src="/footer/watermark.svg"
            alt=""
            aria-hidden="true"
            style={{ width: '100%', maxWidth: '1240px', height: 'auto', display: 'inline-block' }}
          />
        </div>

        {/* Bottom bar */}
        <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 40px 32px' }}>
          <div className="ia-footer-bottom">
            <div style={{ display: 'flex', alignItems: 'center', gap: '2px', flexWrap: 'wrap' }}>
              <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.25)' }}>
                © 2026 <strong style={{ fontWeight: 600 }}>ImagineArt, Vyro AI</strong>. All rights reserved.
              </span>
            </div>
